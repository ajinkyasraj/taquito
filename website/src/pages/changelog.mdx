...
- If you depended on `@ecadlabs/beacon-*` (or the original `@airgap/beacon-*`) packages **directly**, replace them with the corresponding `@tezos-x/octez.connect-*` package at `4.8.6`:
