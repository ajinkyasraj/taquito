...
CONFIGS().forEach(({ rpc, protocol, setup, lib }) => {
  ...
  describe(`Test forging pseudo entrypoints: ${rpc}`, () => {
    ...
    const protocolEntrypoints = { 0: 'default', 1: 'root', 2: 'do', 3: 'set_delegate', 4: 'remove_delegate', 5: 'deposit', 6: 'stake', 7: 'unstake', 8: 'finalize_unstake', 9: 'set_delegate_parameters' }
    ...
    Object.values(protocolEntrypoints).forEach(name => {
